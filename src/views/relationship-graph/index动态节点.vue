      ...
      >
        <template #graph-plug>
          <div class="c-my-panel">
            <div
              class="c-my-button"
              :class="{ 'c-my-button-disabled': level2DataIsloaded }"
              @click="loadNextLevel1Data()"
            >
              加载第1层数据
            </div>
            <div
            ...
            <div
              class="c-my-button"
              :class="{ 'c-my-button-disabled': level2DataIsloaded }"
              @click="!level2DataIsloaded && loadNextLevel2Data()"
            >
              加载第2层数据
            </div>
            <div
              ...
              :class="{
                'c-my-button-disabled':
                  !level2DataIsloaded || level3DataIsloaded,
              }"
              @click="
                level2DataIsloaded &&
                  !level3DataIsloaded &&
